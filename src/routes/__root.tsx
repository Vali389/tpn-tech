  ...
  head: () => ({
    meta: [
      ...
      { title: "TPN Tech | AI-Driven Staffing & Talent Solutions" },
      {
        name: "description",
        content:
          "TPN Tech pairs AI recruitment with specialist recruiters to deliver IT, contract, permanent and executive talent fast.",
      },
      { name: "author", content: "TPN Tech" },
      { property: "og:title", content: "TPN Tech | AI-Driven Staffing & Talent Solutions" },
      {
        property: "og:description",
        content: "AI-matched shortlists, human-vetted talent. Staffing built for teams that hire with intent.",
      },
